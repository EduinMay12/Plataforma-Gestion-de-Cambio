            ...
            <div class="row">
                <div class="col-4">
                    <div class="form-group">
                        ...
                        @error('fechainicio') <span class="error badge badge-danger">{{ $message }}</span>@enderror
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
                        ...
                        @error('fechafin') <span class="error badge badge-danger">{{ $message }}</span>@enderror
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
            ...
            <div class="card">
                <div class="card-body">
                   <div class="row">
                        ...
                        <br>
                        <div><br>
                            <button class="mt-2 btn btn-success" wire:click="create" wire:loading.attr="disabled" wire:target="create">Agregar</button>
                        </div>
                   </div>
