    ...
    <div class="row mt-2">
        ...
        <div class="col-4">
            <a target="_blank" class="btn btn-info" href="{{ route('preguntas-multiples.pdf')}}">
    ...
    @if ($asignacioncuestionario1s->count())
        ...
        <table class="table table-bordered mt-4">
            ...
            <tbody>
                @foreach ($asignacioncuestionario1s as $asignacioncuestionario)
    ...
    <nav aria-label="Page navigation example" class="float-right">
        <ul class="pagination">
            <li class="page-item">
                {{ $asignacioncuestionario1s->links() }}
            </li>
        </ul>
    </nav>

    <div class="mt-3">
        <p> Mostrando {{ $asignacioncuestionario1s->firstItem() }} a {{ $asignacioncuestionario1s->lastItem() }} de {{ $asignacioncuestionario1s->total() }} Entradas</p>
    </div>
