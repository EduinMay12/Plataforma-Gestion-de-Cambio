    ...
    <div class="row mt-2">
        ...
        <div class="col-4">
            <button wire:click="create" class="btn btn-primary">Agregar Asignación de Cuestionario<i
    ...
    @if ($asignacioncuestionarios->count())
        ...
        <table class="table table-bordered mt-4">
            ...
            <tbody>
                @foreach ($asignacioncuestionarios as $asignacioncuestionario)
    ...
    <nav aria-label="Page navigation example" class="float-right">
        <ul class="pagination">
            <li class="page-item">
                {{ $asignacioncuestionarios->links() }}
            </li>
        </ul>
    </nav>

    <div class="mt-3">
        <p> Mostrando {{ $asignacioncuestionarios->firstItem() }} a {{ $asignacioncuestionarios->lastItem() }} de {{ $asignacioncuestionarios->total() }} Entradas</p>
    </div>
