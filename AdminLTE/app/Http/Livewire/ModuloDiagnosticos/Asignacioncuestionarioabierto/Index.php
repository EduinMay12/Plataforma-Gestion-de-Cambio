...
class Index extends Component
{
    ...
    {
        $asignacioncuestionariosabiertos = Asignacioncuestionarioabierto::select('asignacioncuestionarioabiertos.id','users.name','asignacioncuestionarioabiertos.fecha_asignada','asignacioncuestionarioabiertos.fecha_limite','asignacioncuestionarioabiertos.cuestionario_id')
        ->join('users','asignacioncuestionarioabiertos.participante_id','=','users.id')
        ->where('users.name', 'like', '%'. $this->search. '%')
        ->orderBy($this->sort, $this->direction)
        ->paginate($this->cant);
        return view('livewire.modulo-diagnosticos.asignacioncuestionarioabierto.index', compact('asignacioncuestionariosabiertos'));
    }

    public function create(){

        $this->users = User::all()->where('estatus', '=', '4');
        $this->cuestionarios = Cuestionario1::all()->where('estatus', '=', '1');
    ...
    public function store(){
        ...
        Asignacioncuestionarioabierto::create([
    ...
    public function show(Asignacioncuestionarioabierto $asignacioncuestionario){
    ...
    public function edit(Asignacioncuestionarioabierto $asignacioncuestionario){
        ...
        $this->preguntas = Preguntas1::where('cuestionario_id', '=', $this->cuestionario_id)->get();
        $this->view = 'edit';
    }
    ...
    public function update(){
        ...
        $this->asignacion = Asignacioncuestionarioabierto::find($this->asignacion_id);
    ...
    public function destroy(Asignacioncuestionarioabierto $asignacioncuestionario){
