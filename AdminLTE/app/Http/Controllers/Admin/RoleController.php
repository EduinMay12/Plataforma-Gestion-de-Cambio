...
class RoleController extends Controller
{
    ...
    {
         $this->middleware('permission:ver-etiqueta|crear-etiqueta|editar-etiqueta|eliminar-etiqueta', ['only' => ['index','store']]);
         $this->middleware('permission:crear-etiqueta', ['only' => ['create','store']]);
         $this->middleware('permission:editar-etiqueta', ['only' => ['edit','update']]);
         $this->middleware('permission:eliminar-etiqueta', ['only' => ['destroy']]);
    }
